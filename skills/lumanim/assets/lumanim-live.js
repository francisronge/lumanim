(() => {
  const stage = document.querySelector("[data-lumanim-stage]");
  ...
  const explore = document.querySelector("[data-lumanim-explore]");
  const replay = document.querySelector("[data-lumanim-replay]");
  const reconnect = document.querySelector("[data-lumanim-reconnect]");
  const controlsPanel = document.querySelector("[data-lumanim-controls]");
  const controls = [...document.querySelectorAll("[data-lumanim-control]")];
  ...
  const updateReadout = (control) => {
    const output = document.querySelector(`[data-lumanim-output="${control.dataset.lumanimControl}"]`);
